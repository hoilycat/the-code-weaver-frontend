...
const ROADMAP_BY_ID = {
  ...
  2: {
    ...
    checkpoints: [
      ...
      { label: "YIE /rag/query pattern insight", done: true },
      { label: "CoachChat live AI response", done: true },
      { label: "Demo media and Vitest checks", done: true },
    ],
    next: [
      { label: "Dedicated /rag/evidence endpoint", done: false },
      { label: "Production YIE API environment wiring", done: false },
  ...
  3: {
    ...
    checkpoints: [
      ...
      { label: "YIE GraphRAG evidence cards", done: true },
