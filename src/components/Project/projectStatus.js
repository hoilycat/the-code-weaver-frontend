...
const ROADMAP_BY_ID = {
  ...
  11: {
    statusKey: "mvp",
    checkpoints: [
      { label: "OpenCV C++ feature pipeline", done: true },
      { label: "SVM 4-class classifier, 86.2%", done: true },
      { label: "RIAWELC polygon-to-YOLO conversion", done: true },
      { label: "RT YOLOv8 pilot model", done: true },
      { label: "VT YOLOv8 model, best mAP50 0.847", done: true },
      { label: "RT/VT Gradio inspection workflow", done: true },
      { label: "Risk, cause, and action explanations", done: true },
      { label: "Final report and demo guide", done: true },
    ],
    next: [
      { label: "독립 현장 이미지 평가", done: false },
      { label: "RT 및 언더컷 성능 개선", done: false },
    ],
  },
};
